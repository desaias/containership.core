        ...
        this.myriad.listen(() => {
            ...
            Ohai.detect((err, data) => {
                ...
                if(!err) {
                    ...
                    _forEach(OHAI_ATTRIBUTES, (key) => {
                        if (_has(flat_data, key)) {
            ...
            // join channels
            _forEach(self.core.options.channels, (channel) => {
            ...
            self.legiond.on('promoted', (/*data*/) => {
                ...
                self.core.loggers['containership.core'].log('verbose', `Controlling cluster of ${_values(peers).length} nodes`);
                _forEach(peers, (host/*, id*/) => {
